export const AbilitiesText: { [k: string]: AbilityText } = {
	...
	superconductor: {
		...
		shortDesc:
			"This Pokemon's Steel-type moves become Electric type and have 1.2x power.",
	},
	aftermath: {
		name: "Aftermath",
	...
	lightningrod: {
		...
		gen4: {
			...
			shortDesc:
				"This Pokemon draws single-target Electric moves to itself.",
		},
		gen3: {
	...
	triage: {
		name: "Triage",
		shortDesc:
			"This Pokemon's healing moves have their priority increased by 1.",
	},
	truant: {
		name: "Truant",
