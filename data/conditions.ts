export const Conditions: { [k: string]: ConditionData } = {
	 ...
	 * - data/mods/eliteredux/pokedex.ts, contains the pokedex definitions for all elite redux formats. Use this for testing to give pokemon new abilities prior to them being implemented fully.
